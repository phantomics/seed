...
(in-package #:seed.ui-spec.css.base)
	 ...
	 (div.pane
	  ...
	  (.matrix-view
	   (table.form
	    ...
	    ((:or .list-interface-holder .menu-holder)
	     (.panel
	      :width "calc(100% - 12px)"
...
(defmacro css-symbol-style-camel-case ()
  `((.seed-symbol
     ((:and span :|not(:first-child)|)
...
(defmacro css-symbol-style-dash-separated ()
  `((.seed-symbol
     ((:and span :|not(:first-child)|)
      ((:and .fl :before)
       :content "-"
...
(defmacro css-symbol-style-underscore-separated ()
  `((.seed-symbol
     ((:and span :|not(:first-child)|)
      ((:and .fl :before)
       :content "_"
