...
(fx (span (fx "line" (:fx :uicc-select) (:type :select) (:options "line" "retraceX" "retraceY"))
          (fx (nth 0 '(:none :left :right :both)) (:fx :uicc-button) (:type)
              (:role (uir-toggle :symap '(:| ∘─∘ | :|─∘─∘ | :| ∘─∘─| :─∘─∘─))))
          (fx 0 (:fx :uicc-field) (:type :numeric :integer))
          (fx 0 (:fx :uicc-field) (:type :numeric :float))
          (fx 0 (:fx :uicc-field) (:type :numeric :integer))
          (fx 0 (:fx :uicc-field) (:type :numeric :float)))
   (:fx :uic-series :layout (:groups :rows (-2 4)))
...
(fx (list (fx "type" (:fx :uicc-select) (:type :select) (:options "line" "retraceX" "retraceY"))
