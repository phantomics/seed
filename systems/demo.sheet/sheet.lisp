...
;; (fx (:cues :add (fx ((fx (:image . "none") (:template meta-template.customers-image))
...
;;                (:fx :uic-series :layout (:groups :rows (-1 1)))
;;                (:role (uir-reducable))))
;;     (:fx :uic-series :layout (:groups :rows (-2 0))) (:type :called :removable)
;;     (:role uir-reducable (uir-sortable :range 2)))
