        ...
        (seed.generate::build-directed-graph
         ...
         (((meta (:title . "Asking for help, can't explain ID")
           ...
           (meta
            ...
            (:fx . :uicc-field) (:type :text :pair :named :block)))
          (((meta (:title . "Help how?") (:fx . :uicc-field)
             (:type :text :pair :named :block))
            (meta (:dialog . "How am I supposed to help you?")
             (:fx . :uicc-field) (:type :text :pair :named :block)))
           2)
          (((meta (:title . "No, tell who") (:fx . :uicc-field)
             (:type :text :pair :named :block))
            (meta (:dialog . "First tell me who you are, this makes no sense.")
             (:fx . :uicc-field) (:type :text :pair :named :block)))
           6)
          (((meta (:title . "What's wrong?") (:fx . :uicc-field)
             (:type :text :pair :named :block))
            (meta (:dialog . "Are you in trouble? What's wrong?")
             (:fx . :uicc-field) (:type :text :pair :named :block)))
           3))
         (((meta (:title . "Asking for help") (:fx . :uicc-field)
            (:type :text :pair :named :block))
           (meta (:image . "image-resting") (:title . "Image")
            (:options "no-image" "image-resting" "image-active")
            (:fx . :uicc-select) (:name . :persona-image)
          ...
          (((meta (:title . "What's wrong?") (:fx . :uicc-field)
            ...
            (meta (:dialog . "Are you in trouble? What's wrong?")
             (:fx . :uicc-field) (:type :text :pair :named :block)))
           3))
         (((meta (:title . "What is wrong") (:fx . :uicc-field)
            (:type :text :pair :named :block))
           (meta (:image . "image-resting") (:title . "Image")
            (:options "no-image" "image-resting" "image-active")
            (:fx . :uicc-select) (:name . :persona-image)
           ...
           (meta
            ...
            (:fx . :uicc-field) (:type :text :pair :named :block)))
          (((meta (:title . "How will that destroy") (:fx . :uicc-field)
             (:type :text :pair :named :block))
            (meta (:dialog . "How will that destroy your home?")
             (:fx . :uicc-field) (:type :text :pair :named :block)))
           5)
          (((meta (:title . "What flare?") (:fx . :uicc-field)
             (:type :text :pair :named :block))
            (meta (:dialog . "What is this flare?") (:fx . :uicc-field)
             (:type :text :pair :named :block)))
           5)
          (((meta (:title . "Untitled link") (:fx . :uicc-field)
             (:type :text :pair :named :block))
            (meta (:dialog . "") (:fx . :uicc-field)
             (:type :text :pair :named :block)))))
         (((meta (:title . "I must make contact") (:fx . :uicc-field)
            (:type :text :pair :named :block))
           ...
           (meta
            ...
            (:fx . :uicc-field) (:type :text :pair :named :block)))
          (((meta (:title . "The others?") (:fx . :uicc-field)
             (:type :text :pair :named :block))
            (meta (:dialog . "The 'others?' Who do you mean?")
             (:fx . :uicc-field) (:type :text :pair :named :block)))
           7)
          (((meta (:title . "How to contact") (:fx . :uicc-field)
             (:type :text :pair :named :block))
          ...
          (((meta (:title . "Untitled link") (:fx . :uicc-field)
            ...
            (meta (:dialog . "") (:fx . :uicc-field)
             (:type :text :pair :named :block)))))
         (((meta (:title . "How home will be destroyed") (:fx . :uicc-field)
            (:type :text :pair :named :block))
           (meta (:image . "image-active") (:title . "Image")
            (:options "no-image" "image-resting" "image-active")
            (:fx . :uicc-select) (:name . :persona-image)
           ...
           (meta
            ...
            (:fx . :uicc-field) (:type :text :pair :named :block)))
          (((meta (:title . "What space?") (:fx . :uicc-field)
             (:type :text :pair :named :block))
            (meta (:dialog . "What space? And just who are you?")
             (:fx . :uicc-field) (:type :text :pair :named :block)))
           6)
          (((meta (:title . "Solar flare does what?") (:fx . :uicc-field)
             (:type :text :pair :named :block))
         ...
         (((meta (:title . "I'm an entity in information space")
           ...
           (meta
            ...
            (:fx . :uicc-field) (:type :text :pair :named :block)))
          (((meta (:title . "You're an AI?") (:fx . :uicc-field)
             (:type :text :pair :named :block))
            (meta
             (:dialog . "You mean you're like an artificial intelligence?")
             (:fx . :uicc-field) (:type :text :pair :named :block)))
           2)
          (((meta (:title . "Is this a joke?") (:fx . :uicc-field)
             (:type :text :pair :named :block))
            (meta (:dialog . "Is this a joke?") (:fx . :uicc-field)
             (:type :text :pair :named :block)))
           2)
          (((meta (:title . "How you can exist") (:fx . :uicc-field)
             (:type :text :pair :named :block))
          ...
          (((meta (:title . "Untitled link") (:fx . :uicc-field)
            ...
            (meta (:dialog . "") (:fx . :uicc-field)
             (:type :text :pair :named :block)))))
         (((meta (:title . "They are through the 'doors'") (:fx . :uicc-field)
            (:type :text :pair :named :block))
           (meta (:image . "image-active") (:title . "Image")
            (:options "no-image" "image-resting" "image-active")
            (:fx . :uicc-select) (:name . :persona-image)
           ...
           (meta
            ...
            (:fx . :uicc-field) (:type :text :pair :named :block)))
          (((meta (:title . "What doors?") (:fx . :uicc-field)
             (:type :text :pair :named :block))
            (meta (:dialog . "What doors?") (:fx . :uicc-field)
             (:type :text :pair :named :block)))
           2)
          (((meta (:title . "Ask again to explain") (:fx . :uicc-field)
             (:type :text :pair :named :block))
            (meta
             (:dialog
         ...
         (((meta (:title . "Untitled node") (:fx . :uicc-field)
            (:type :text :pair :named :block))
           (meta "" (:title . "Image") (:options "none" "resting" "active")
            (:name . :persona-image) (:fx . :uicc-select) (:type :select))
           (meta (:dialog . "") (:fx . :uicc-field)
            (:type :text :pair :named :block))))
         (((meta (:title . "Untitled node") (:fx . :uicc-field)
            (:type :text :pair :named :block))
